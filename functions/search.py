...
def search_google(query: str, **kwargs: dict) -> list[dict]:
    ...
    Args:
        ...
        kwargs (dict): The keyword arguments to pass to the search API
    Returns:
        list[dict]:  A list of python dictionaries containing the search results.

    Examples:
        >>> search_google('What is young sheldon?')
        [
        ...
        >>> search_google('How to use pandas in python?')
        [
